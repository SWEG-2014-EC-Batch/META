...
int stringInput(char messageOne[], char choice, char messageTwo[] = "")
{
    if(choice == 'C')
    {
        std::cout << "\nInput first string: ";
        std::cin.get(messageOne, MESSAGE_LENGTH);
        std::cin.ignore();
        std::cout << "\nInput second string: ";
        std::cin.get(messageTwo,MESSAGE_LENGTH);
    }
    else
    {

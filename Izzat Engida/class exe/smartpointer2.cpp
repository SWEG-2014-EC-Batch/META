...
cout<<"Address 1: "<<ptr1<<"\nAddress 2: "<<ptr2<< endl;
// Returns the number of shared_ptr objects referring to the same managed object. cout<<"Shared Objects (ptr1): " << ptr1.use_count() << endl; cout<<"Shared Objects (ptr2): "<< ptr2.use_count() << endl;
//Relinquishes ownership of ptr1 on the object and pointer becomes NULL ptr1.reset();
...
// invalid: accessing a pointer that release an object // *ptr2 = 10; cout << *ptr2<< endl;
ptr3.reset();
